...
# Import list of stopwords from tct file as a list
stopword_text = open("D:/BKSI_refurbishment/scrapping/stopwords/stopword_1942.txt", "r", encoding='utf-8')
...
for i in range(2, 3):
    try:
        ...
        data = data.replace('.\n', " ")
        data = data.replace('! ', " ")
        data = data.replace(" của ", " ")
        data = data.replace(' qua ', " ")
        data = data.replace(' các ', " ")
        data = data.replace(' tất ', " ")
        print(data)
